...
import { ChevronRight, Github, Linkedin, Mail, Send, Star } from "lucide-react";
import { USER_INFO_CONSTANT } from "@/constants/config/info";
import meImg from "../assets/images/me-2.png";
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-900 dark:to-gray-800">
      <main className="flex-1">
          ...
          <div className="container mx-auto text-center">
            ...
            >
              ...
              <p className="mx-auto max-w-[700px] text-gray-500 md:text-xl dark:text-gray-400 mb-8">
                With over 4 years of experience, I craft exceptional digital
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                <p className="text-gray-500 dark:text-gray-400 md:text-lg mb-4">
                  I'm a seasoned frontend developer with a passion for creating
                  seamless user experiences. My journey in web development began
                  over 4 years ago, and since then, I've had the privilege of
                  working on a diverse range of projects, from small business
                  websites to large-scale enterprise applications.
                </p>
                <p className="text-gray-500 dark:text-gray-400 md:text-lg mb-4">
                  My expertise lies in building responsive, accessible, and
                  performant web applications using modern technologies like
                  React, Next.js, and TypeScript. I'm constantly exploring new
                  tools and techniques to stay at the forefront of frontend
                  development.
                </p>
                <p className="text-gray-500 dark:text-gray-400 md:text-lg">
                  When I'm not coding, you can find me contributing to
                  open-source projects, writing technical articles, or mentoring
                  aspiring developers.
                </p>
              </div>
        ...
        <section
          id="skills"
          className="w-full py-12 md:py-24 lg:py-32 bg-gray-100 dark:bg-gray-800 px-4"
        >
          <div className="container mx-auto">
          ...
          <div className="container mx-auto text-center">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {[1, 2, 3].map((testimonial) => (
                <Card
                  key={testimonial}
                  className="bg-white/10 backdrop-blur-lg text-white"
                >
                  <CardContent className="p-6">
                    <Star className="h-6 w-6 text-yellow-400 mb-4" />
                    <p className="mb-4">
                      "Jane's expertise in frontend development significantly
                      improved our project's performance and user experience.
                      Her attention to detail and problem-solving skills are
                      outstanding."
                    </p>
      ...
      <footer className="w-full py-6 px-4 bg-gray-100 dark:bg-gray-800">
        <div className="container mx-auto flex flex-col md:flex-row justify-between items-center">
          ...
          <nav className="flex gap-4">
            <Link
              href={USER_INFO_CONSTANT.CONTACT_US.github}
              className="text-gray-500 hover:text-purple-600 dark:text-gray-400 dark:hover:text-purple-400"
            >
              <Github className="h-5 w-5" />
            </Link>
            <Link
              href={USER_INFO_CONSTANT.CONTACT_US.linkedIn}
              className="text-gray-500 hover:text-purple-600 dark:text-gray-400 dark:hover:text-purple-400"
            >
              <Linkedin className="h-5 w-5" />
            </Link>
            <Link
              href={USER_INFO_CONSTANT.CONTACT_US.email}
              className="text-gray-500 hover:text-purple-600 dark:text-gray-400 dark:hover:text-purple-400"
            >
